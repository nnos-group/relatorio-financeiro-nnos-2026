    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="glass-card rounded-2xl overflow-hidden border border-amber-500/30">
        ...
        <div class="p-5 space-y-3 text-xs text-gray-300 leading-relaxed">
          ...
          <p><strong class="text-white">● Carga Tributária sobre o Faturamento:</strong> ISS efetivo somado ao PIS/COFINS (6,15%) sobre a receita bruta representa um dos principais redutores da Receita Líquida. Estruturar um planejamento tributário orientado ao tipo de serviço pode gerar redução relevante na carga fiscal.</p>
