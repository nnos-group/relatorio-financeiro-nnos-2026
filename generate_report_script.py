...
<nav class="sticky top-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-white/10 shadow-lg">
  <div class="max-w-[1440px] mx-auto px-6 overflow-x-auto">
    <div class="flex items-center justify-between gap-2 py-2.5 min-w-max">
      ...
      <button onclick="logout()" class="px-3.5 py-1.5 rounded-lg text-xs font-bold text-rose-300 hover:bg-rose-500/20 border border-rose-500/30 transition-colors flex items-center gap-1.5 ml-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="glass-card rounded-2xl overflow-hidden border border-amber-500/30">
        ...
        <div class="p-5 space-y-3 text-xs text-gray-300 leading-relaxed">
          ...
          <p><strong class="text-white">● Comissões Concentradas no 1º Trimestre:</strong> R$ 44,7k em comissões, com pico em Março e Abril. A ausência de comissões em Junho indica sazonalidade ou lacunas na ativação comercial — vale estruturar um plano de incentivo contínuo ao time de vendas.</p>
      ...
      <div class="glass-card rounded-2xl overflow-hidden border border-rose-500/30">
        ...
        <div class="p-5 space-y-3 text-xs text-gray-300 leading-relaxed">
          ...
          <p><strong class="text-white">● Endividamento Bancário Monitorado:</strong> Empréstimos bancários totalizam R$ 504,8k YTD de saídas — valor relevante que exige acompanhamento do fluxo de caixa e avaliarção do custo efetivo de capital para priorizar a quitação de operações com juros mais altos.</p>
